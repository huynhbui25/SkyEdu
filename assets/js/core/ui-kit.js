            ...
            if (!overlay) {
                ...
                overlay.innerHTML = `<div class="sky-modal">
                    <div class="sky-modal-header">
                        ...
                        <button class="sky-modal-close" aria-label="Đóng">×</button>
                    </div>
        ...
        confirm(opts) {
            return new Promise((resolve) => {
                this.modal({
                    ...
                    footer: `<button class="btn btn-secondary sky-cancel">Hủy</button>
                             <button class="btn ${opts.danger ? 'btn-danger' : 'btn-primary'} sky-ok">${opts.okText || 'Xác nhận'}</button>`,
