        ...
        modal.innerHTML = `
            ...
            <div class="modal-content">
                ...
                <div class="modal-buttons">
                    <button type="button" class="btn-cancel" onclick="document.getElementById('antiCheatModal').remove(); if(window.antiCheatCallback) window.antiCheatCallback(false);">Hủy</button>
